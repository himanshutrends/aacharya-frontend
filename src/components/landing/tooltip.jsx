...
export default function Tooltip({ children, content, id, dark = false }) {
  const [open, setOpen] = useState(false)

  return (
    <div className="relative">
      <button
        className={`block text-left text-zinc-500 underline decoration-dotted underline-offset-4 cursor-help ${
